...
from boatrace.index_features import COMPONENT_KEYS, tenkai_yui_pt  # noqa: E402
...
class TestRegistryV2Tenkai:
    ...
    def test_v2_tenkai_has_six_components(self):
        v2 = predictor_by_id("v2_tenkai")
        assert v2.component_keys == (
            "waku", "racer", "motor", "exhibit", "weather", "tenkai",
        )

    def test_tenkai_label_is_registered(self):
