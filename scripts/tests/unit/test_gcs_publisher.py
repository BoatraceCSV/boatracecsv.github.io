...
def test_build_csv_specs_includes_results():
    ...
    # racer_st (選手別 推定ST)、2026-07-21 に v5_slit を投入。2026-07-22〜28 に
    # 投入した v6_course / v7_aggregate / v8_aionly は 2026-08-09 に退役
    # (control 比で有意に低回収率) したため、現在の active は
    # v1_basic / v4_motor / v5_slit (slot 順)。
    assert csv_types == [
        "title",
        "race_cards",
        "stt",
