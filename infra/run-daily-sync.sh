...
ACTIVE_PREDICTORS=(v1_basic v4_motor v5_slit v6_course v7_aggregate)  # 2026-07-23: v7_aggregate (統合予想: motor4+course+AI推定ST) 投入 / 2026-07-22: v6_course (コースpt) 投入 / 2026-07-20: v5_slit (AI推定ST)・v4_motor 投入 / 2026-07-19: v2_tenkai/v3_tenkai を退役 (registry active_predictors() と同期)
