...
| 結果 | Results (確定) | `data/results/daily/YYYY/MM/DD.csv` | [results.md#results-確定](./results.md#results-確定) |
...
- `https://boatracecsv.github.io/data/results/daily/2026/01/01.csv`
